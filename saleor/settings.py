...
# DEPLOYMENT TEST June 7 2021

SUPPORT_EMAIL = os.environ.get("SUPPORT_EMAIL")
DISABLE_PAYMENT_EMAIL = get_bool_from_env("DISABLE_PAYMENT_EMAIL", False)
DISABLE_INITIAL_FULFILLMENT_EMAIL = get_bool_from_env("DISABLE_INITIAL_FULFILLMENT_EMAIL", False)